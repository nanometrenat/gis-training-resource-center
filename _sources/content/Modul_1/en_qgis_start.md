...
![QGIS_User_Interface](en_QGIS_User_Interface-1.png)
User interface
...
![Project template](en_project_template_BRC-1.png)
Project template
...
![Add a vector file](<en_Add_ a_vector_file_a.png>)
Add a vector file 
...
![Add_basemaps](en_Add_basemaps-1.png) 
...
![Excel_data03](en_Excel_Data_c.png)
...
![Excel_data04](en_Excel_Data_d.png)
...
![Excel_data05](en_Excel_Data_e.png)
...
![Attribute table](en_Attribute_table-3.png)

Ressource: BRC Session 1, p. 38-50
...
-  __Download the data__: https://gitlab.gistools.geog.uni-heidelberg.de/giscience/disaster-tools/gis-in-anticipatory-humanitarian-action/-/blob/main/Exercise_0/Ex0_data.zip
...
![Excercise0_a](en_Excercise_0_a.png)

![Excercise0_b](en_Excercise_0_b.png)

See also:

<a href=”./2022_Tutoriel_QGIS_CartONG_EN_p06”>cartONG-QGIS-Tutorial,  p. 6</a>: Presentation of the interface
...
- Changes the projection in the map view to __WGS 84 / Pseudo-Mercator - EPSG:3857__. Note that this does not change the projection (the coordinates) of the files, but only affects the projection of the map view.  Check this in the properties of the point layer. __Which projection is indicated there?__
 ...
 ```{hint} text 
Hint: You can use the searchbar on the top
 ```
...
![Excercise1_a](en_Excercise_1_a.png)

![Excercise1_b](en_Excercise_1_b.png)

### Interface:

#### Overview

![Alt text](en_Interface_01.png)
...
https://gitlab.gistools.geog.uni-heidelberg.de/giscience/disaster-tools/gis-in-anticipatory-humanitarian-action/-/wikis/uploads/1655b97b741749bfa46c6c08ee3d0be6/qgis_open_project.mp4
 ...
 ```{hint} text 
Hint: The layer data used in the project is not saved in the project file
 ```
...
See also: 
 ...
 <a href=”./2022_Tutoriel_QGIS_CartONG_EN_p07-09”>cartONG-QGIS-Tutorial, p. 7 - 9: </a> Structuring a QGIS Project 
